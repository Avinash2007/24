...
open class FooterView: UIView {
  ...
  let gradientColors = [#colorLiteral(red: 0.01568627451, green: 0.01568627451, blue: 0.01568627451, alpha: 0.1), #colorLiteral(red: 0.01568627451, green: 0.01568627451, blue: 0.01568627451, alpha: 1)]
